...
banner "Train Elastic-v4-BN FROM K3 | final stats use causal-prefix BN bank"
...
echo "[NORM]          per-width BatchNorm during training; running stats are disposable"
...
echo
echo "[DONE] Elastic raw checkpoint: ${RAW_CKPT}"
echo "[IMPORTANT] Do NOT run global 83-profile BN calibration."
echo "[NEXT] Build causal-prefix BN statistics with:"
echo "  ./scripts/stream_exp/23_calibrate_causal_prefix_bn_bank.sh ${ELASTIC_EPOCHS} 100"
