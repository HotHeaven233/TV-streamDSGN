...
OUT_DIR="outputs/paper_figures/frequency_sweep"

PYTHON_SCRIPT="tools/plot_no_load_frequency_sweep.py"
...
echo "============================================================"
echo "PLOT FORMAL NO-LOAD FREQUENCY SWEEP"
echo "============================================================"
echo "repo       : ${REPO_ROOT}"
echo "exp        : ${EXP_NAME}"
...
echo
echo "============================================================"
echo "FREQUENCY SWEEP FIGURE COMPLETE"
echo "============================================================"
